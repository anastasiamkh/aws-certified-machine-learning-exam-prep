...
1. $${\color{fuchsia}Find Your Gaps}$$ Take the practice exam to find **where your gaps are** and which topics you need to cover. If you scored 70+ points on your first try, perhaps it doesn't make sense to spend 20h on teh video course and you should focus on specific ML topic/AWS services only. 
